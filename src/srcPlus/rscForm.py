...
from PyQt5.Qt import QPushButton, QTabWidget,\
    ...
    QDateTime, QDate, QDateEdit, QTimeEdit, QGroupBox, QDateTimeEdit, QAction
...
def configprivilege(dictIn = None):
    lstWdg = dictIn['menus']
    lstPrev = dictIn['level']
    userLevel = int(config.dictSession['Level'])
