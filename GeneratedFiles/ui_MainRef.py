...
"}")
        ...
        self.PBVizualizar = QtWidgets.QPushButton(MainForm)
        self.PBVizualizar.setText("")
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/newPrefix/Icons/001-medical.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.PBVizualizar.setIcon(icon4)
        self.PBVizualizar.setIconSize(QtCore.QSize(25, 25))
        self.PBVizualizar.setFlat(False)
        self.PBVizualizar.setObjectName("PBVizualizar")
        self.verticalLayout.addWidget(self.PBVizualizar)
        self.PBEditar = QtWidgets.QPushButton(MainForm)
        self.PBEditar.setText("")
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/newPrefix/Icons/005-writer.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.PBEditar.setIcon(icon5)
    ...
    def retranslateUi(self, MainForm):
        ...
        self.PBVizualizar.setWhatsThis(_translate("MainForm", "Adicionar"))
